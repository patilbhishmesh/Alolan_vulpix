      ...
      .addFields(
        ...
        },
        {
          ...
          value:
            ...
            "🔸 `ai-catch <id/start/stop>` - Enable/disable P2 ASS identification\n" +
        ...
        },
        {
          name: "🔧 **Captcha Solver**",
          value:
            "🔸 `solver <token> <userid>` - Test captcha solver for specific account\n" +
...
app.listen(PORT, "0.0.0.0", () => {
  console.log(`Ping server active on port ${PORT}`);
});
